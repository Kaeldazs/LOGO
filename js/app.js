...
var turtle = {
    ...
    getColorLine: function() {
        return [
            Math.round(this.colorLine[0] - this.currentColorMove[0]),
            Math.round(this.colorLine[1] - this.currentColorMove[1]),
            Math.round(this.colorLine[2] - this.currentColorMove[2])
        ]
    },
    getPos: function() {
        return [
    ...
    reset: function() {
        ...
        this.shadow = 0;
        this.colorLine = [255, 255, 255];
        this.currentColorMove = [0, 0, 0];
    },
    set: function() {
        this.reset();
    }
...
function drawLogo() {
    ...
    var cmd = 'POUR circle :s REPETE :s [AV 20 TD 24] FIN FCC #BA68C8 TG 40 LC AV 310 TG 140 BC AV 200 REPETE 5 [AV 20 TG 24] LC TD 30 FCC #F0A32F AV 60 TG 90 AV 93 TD 90 BC circle 16 FCC #EC4A94 LC TG 24 AV 100 BC circle 16 LC RE 10 TD 66 AV 100 TG 75 BC circle 10 TD 56 circle 5 TG 164 LC FCC #F9ED3A AV 160 TD 90 AV 78 BC circle 16 LC RE 10 TD 68 AV 47 TG 90 RE 120 TG 90 BC';
